...
/* AppendUserToModOK describes a response with status code 200, with default header values.
...
func (o *AppendUserToModOK) GetPayload() *models.GeneralError {
	return o.Payload
}
...
/* AppendUserToModForbidden describes a response with status code 403, with default header values.
...
func (o *AppendUserToModForbidden) GetPayload() *models.GeneralError {
	return o.Payload
}
...
/* AppendUserToModPreconditionFailed describes a response with status code 412, with default header values.
...
func (o *AppendUserToModPreconditionFailed) GetPayload() *models.GeneralError {
	return o.Payload
}
...
/* AppendUserToModUnprocessableEntity describes a response with status code 422, with default header values.
...
func (o *AppendUserToModUnprocessableEntity) GetPayload() *models.GeneralError {
	return o.Payload
}
...
/* AppendUserToModDefault describes a response with status code -1, with default header values.
...
func (o *AppendUserToModDefault) GetPayload() *models.GeneralError {
	return o.Payload
}
