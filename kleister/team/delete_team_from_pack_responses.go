...
/* DeleteTeamFromPackUnprocessableEntity describes a response with status code 422, with default header values.
...
func (o *DeleteTeamFromPackUnprocessableEntity) GetPayload() *models.GeneralError {
	return o.Payload
}
