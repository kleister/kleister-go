...
/* DeleteTeamFromModUnprocessableEntity describes a response with status code 422, with default header values.
...
func (o *DeleteTeamFromModUnprocessableEntity) GetPayload() *models.GeneralError {
	return o.Payload
}
