...
func (m *Neoforges) validateVersions(formats strfmt.Registry) error {
...
func (m *Neoforges) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
