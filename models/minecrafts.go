...
func (m *Minecrafts) validateVersions(formats strfmt.Registry) error {
...
func (m *Minecrafts) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
